...
class ClientsNearbyPage extends StatefulWidget {
  const ClientsNearbyPage({super.key});

  @override
  State<ClientsNearbyPage> createState() => _ClientsNearbyPageState();
}

class _ClientsNearbyPageState extends State<ClientsNearbyPage> {
  int _currentPage = 1;
  int _rowsPerPage = 20;
