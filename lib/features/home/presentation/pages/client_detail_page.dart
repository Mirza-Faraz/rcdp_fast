          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    _buildClientInfo(clientName, displayId),
                    const SizedBox(height: 24),
                    _buildMenuItems(context, clientName, displayId),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildMenuItems(BuildContext context, String clientName, String clientId) {
    final menuItems = [
      _MenuItemData(
        ...
        route: 'basic_client_info',
        iconColor: Colors.blue,
      ),
      _MenuItemData(
        icon: Icons.group,
        title: 'Group Formation',
        route: 'group_formation',
        iconColor: Colors.purple,
      ),
      _MenuItemData(
        icon: Icons.description,
        title: 'Loan Formation Information',
        route: 'loan_formation',
        iconColor: Colors.indigo,
      ),
      _MenuItemData(
        icon: Icons.business_center,
        title: 'Client Business Information',
        route: 'client_business_info',
        iconColor: Colors.brown,
      ),
      _MenuItemData(
        icon: Icons.home,
        title: 'Details of Domestic Income',
        route: 'domestic_income',
        iconColor: Colors.green,
      ),
      _MenuItemData(
        icon: Icons.local_hospital,
        title: 'Household Facilities and Health Status',
        route: 'household_facilities',
        iconColor: Colors.red,
      ),
      _MenuItemData(
        icon: Icons.pets,
        title: 'Household Assets, Livestock & CashFlow',
        route: 'household_assets',
        iconColor: Colors.purple,
      ),
      _MenuItemData(
        icon: Icons.checklist,
        title: 'Loan Utiliser Information',
        route: 'loan_utilizer_info',
        iconColor: Colors.teal,
      ),
      _MenuItemData(
        icon: Icons.person_add,
        title: 'Guarantor Information',
        route: 'guarantor_info',
        iconColor: Colors.blue,
      ),
      _MenuItemData(
      ...
      _MenuItemData(
        ...
        route: 'loan_submission',
        iconColor: Colors.green,
      ),
      _MenuItemData(
        icon: Icons.approval,
        title: 'Approval Submission',
        route: 'approval_submission',
        iconColor: Colors.blue,
      ),
    ];
  ...
  void _navigateToForm(
    ...
    switch (route) {
      case 'basic_client_info':
        page = BasicClientInfoPage(
          clientName: clientName,
          clientId: clientId,
        );
        break;
      case 'group_formation':
        page = GroupFormationPage(
          clientName: clientName,
          clientId: clientId,
          cnic: cnic,
          memberId: memberId,
      ...
      case 'client_business_info':
        page = ClientBusinessInfoPage(
          clientName: clientName,
          clientId: clientId,
        );
        break;
      case 'domestic_income':
        page = DomesticIncomePage(
          clientName: clientName,
          clientId: clientId,
        );
        break;
      case 'household_facilities':
        page = HouseholdFacilitiesPage(
          clientName: clientName,
          clientId: clientId,
        );
        break;
      case 'household_assets':
        page = HouseholdAssetsPage(
          clientName: clientName,
          clientId: clientId,
        );
        break;
      case 'loan_utilizer_info':
        page = LoanUtilizerInfoPage(
          clientName: clientName,
          clientId: clientId,
        );
        break;
      case 'guarantor_info':
        page = GuarantorInfoPage(
          clientName: clientName,
          clientId: clientId,
        );
        break;
      ...
      case 'loan_submission':
        page = LoanSubmissionPage(
          clientName: clientName,
          clientId: clientId,
        );
        break;
      case 'approval_submission':
        page = ApprovalSubmissionPage(
          clientName: clientName,
          clientId: clientId,
        );
        break;
